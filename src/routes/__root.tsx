...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pulse11 — Monta tu 11 ideal" },
      { property: "og:description", content: "Pulse11: arma tu 11 ideal, compite en ligas privadas con amigos. Sin apuestas, sin tóxicos. 14+." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Pulse11 — Monta tu 11 ideal" },
      { name: "twitter:description", content: "Pulse11: arma tu 11 ideal, compite en ligas privadas con amigos. Sin apuestas, sin tóxicos. 14+." },
