...
export const Route = createFileRoute("/legal/terminos")({
  head: () => ({ meta: [{ title: "Términos · 11Pulse" }] }),
  component: () => (
    <div className="min-h-screen flex flex-col">
      ...
      <article className="flex-1 max-w-2xl mx-auto px-4 py-12">
        ...
        <p className="text-muted-foreground mt-4">Al usar 11Pulse aceptas estas reglas básicas.</p>
        <ul className="list-disc pl-6 mt-4 space-y-2">
          ...
          <li>11Pulse puede eliminar cartas o cuentas que incumplan estas reglas.</li>
